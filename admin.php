...
<div class="topnav" id="myTopnav">
  ...
  <a href="medicine_list.php?id=<?php echo $id ?>"><span><b>DRUG LIST</b></span></a>
...
<h2 align="center" style="font-size:30px;color:black"> <b> Insert Drug </b> </h2>
<script>
function myFunction() {
...
<input type="button"  value=" ADD Drug " onclick="check_submit(this)">
</pre>
</form>
</div>
