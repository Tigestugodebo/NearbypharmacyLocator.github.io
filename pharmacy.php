...
<input style="height: 350px;width:900px;padding-bottom: 8px;" type="image" src="assets/images/adababaye.JPG" >
...
if (isset($_SESSION['name'])) {?>
  ...
  style="margin-left: 1000px;font-size:20px; color: #7e97bf;font-weight:bold;">  </a>
...
window.onclick = function(event) {
  ...
  <h4 <bold style="color: #708ab5;padding:5px;margin-left:180px; "> <?php echo "Address: ".$pharmacy_address; ?> </h4>
  <br>
